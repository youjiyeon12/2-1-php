    ...
    <div id="board_box">
        ...
        <ul id="board_list">
            ...
            <?php
                ...
                $sql = "select * from board_general order by num desc"; // 최신글부터 순서대로 불러오는 SQL 쿼리
            ...
            <li>
                ...
                <span class="col2"><a href="board_view.php?num=<?=$num?>&page=<?=$page?>"><?=$subject?></a></span> <!-- 제목 링크 -->
            ...
            <?php
                ...
                for ($i=1; $i<=$total_page; $i++) {
                    if ($page == $i) { // 현재 페이지는 링크 없음
                        ...
                        echo "<li><a href='board_list.php?page=$i'> $i </a><li>"; // 페이지 링크
                    }
                }
        ...
        <ul class="buttons">
            <li><button onclick="location.href='board_list.php'">목록</button></li> <!-- 목록 버튼 -->
            <li>
                <?php 
                    if($userid) { // 사용자 아이디가 존재하는 경우(1, 2, 9 모두 작성 가능)
                ?>
