...
<body> 
<header>
    <?php include "header.php";?> <!--헤더를 포함한다-->
</header>  
<section>
	<div id="main_img_bar">
        <div id="slider">
   	...
   	<div id="message_box">
	    <h3>
<?php
 		if (isset($_GET["page"])) //_GET["page"]에 값이 설정되어 있는지 isset()함수를 이용하여 검산
			$page = $_GET["page"];
		else
			$page = 1;
...
<?php
	$con = mysqli_connect("localhost", "user1", "12345", "music"); //mysql 접근
	...
	$result = mysqli_query($con, $sql); //sql 저장된 데이터 실행
